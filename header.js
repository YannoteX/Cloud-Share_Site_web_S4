...
function generateIDHeader(json){
    ...
    var header ='<div class="header"><a href="http://localhost/" class="logo">Cloud Share</a><div class="header-left"><a href="#contact">Contact</a><a href="#about">About</a></div><div class="header-right"><a href="http://localhost/profile">'+nom+logo+'</a>'+deconnexion+'</div></div>';
    $('#header').html(header);
