...
--
-- Client :  localhost
-- Généré le :  Mer 22 Juin 2022 à 13:42
...
CREATE TABLE `images` (
  ...
  `tags` varchar(150) COLLATE utf8_unicode_ci DEFAULT ''
...
(4, 'personne agees souriante allongée lit retraite', '/IMG/maisons-de-retraite-publiques.jpg', 'website', '$family'),
(5, 'entrée garderie pour enfants', '/IMG/Entrée.jpg', 'website', '$family'),
(6, 'logo famille', '/IMG/famille.png', 'website', '$family'),
(7, 'un dimanche en famille', '/IMG/plage-famille-La-Grande-Motte-1024x682.jpg', 'website', '$family'),
...
(13, 'Cretes de montagne illustration vectorielle du lever du soleil', '/IMG/cretes-montagne-illustration-vectorielle-du-lever-du-soleil_105738-948.jpg', 'website', '$nature'),
...
CREATE TABLE `users` (
  ...
  `contactable` tinyint(4) NOT NULL DEFAULT '0',
  `bio` varchar(500) COLLATE utf8_unicode_ci DEFAULT '',
  `icon` varchar(250) COLLATE utf8_unicode_ci DEFAULT '/ICON/default.png'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `users` (`ID`, `NAME`, `mail`, `passwd`, `contactable`, `bio`, `icon`) VALUES
(1, 'website', 'example@foo.xyz', 'Test12345&', 0, 'user par defaut', '/ICON/default.png');
